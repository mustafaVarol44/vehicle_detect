...
with detection_graph.as_default():
    #od_graph_def = tf.GraphDef()  #TensorFlow 1.x icin bunu secinz 
    #with tf.gfile.GFile(PATH_TO_CKPT, 'rb') as fid:  #TensorFlow 1.x icin bunu secinz 
